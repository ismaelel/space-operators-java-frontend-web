...
public class UserController {
    ...
    public UserController(UserService userService, TokenContext tokenContext, PlayerService playerService) {
    ...
    public String userProfile(Model model, HttpSession session) {
        ...
        PlayerModel playerProfile = userService.getUserInformation();
